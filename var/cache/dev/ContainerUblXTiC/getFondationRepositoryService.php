...
// Returns the private 'App\Repository\FondationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\FondationRepository.php';

return $this->privates['App\Repository\FondationRepository'] = new \App\Repository\FondationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
