...
// Returns the private 'App\Repository\GrosOeuvreRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\GrosOeuvreRepository.php';

return $this->privates['App\Repository\GrosOeuvreRepository'] = new \App\Repository\GrosOeuvreRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
