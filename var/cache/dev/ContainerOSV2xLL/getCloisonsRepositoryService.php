...
// Returns the private 'App\Repository\CloisonsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CloisonsRepository.php';

return $this->privates['App\Repository\CloisonsRepository'] = new \App\Repository\CloisonsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
