...
class srcApp_KernelDevDebugContainerUrlGenerator extends Symfony\Component\Routing\Generator\UrlGenerator
{
    ...
    public function __construct(RequestContext $context, LoggerInterface $logger = null, string $defaultLocale = null)
    {
        ...
        'my-project' => [['id'], ['_controller' => 'App\\Controller\\GrosOeuvreController::view'], [], [['text', '/gros-oeuvre'], ['variable', '/', '[^/]++', 'id', true], ['text', '/dashboard/my-project']], [], []],
        ...
        'menuiserie' => [['id'], ['_controller' => 'App\\Controller\\GrosOeuvreController::menuiserie'], [], [['text', '/gros-oeuvre/menuiseries'], ['variable', '/', '[^/]++', 'id', true], ['text', '/dashboard/my-project']], [], []],
