...
// Returns the private 'App\Repository\RemoveUserRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/RemoveUserRepository.php';

return $this->privates['App\Repository\RemoveUserRepository'] = new \App\Repository\RemoveUserRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
