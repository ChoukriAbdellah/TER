...
// Returns the private 'App\Repository\EscaliersRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EscaliersRepository.php';

return $this->privates['App\Repository\EscaliersRepository'] = new \App\Repository\EscaliersRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
