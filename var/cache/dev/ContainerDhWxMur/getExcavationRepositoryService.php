...
// Returns the private 'App\Repository\ExcavationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ExcavationRepository.php';

return $this->privates['App\\Repository\\ExcavationRepository'] = new \App\Repository\ExcavationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
