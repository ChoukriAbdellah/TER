...
// Returns the private 'App\Repository\MenuiseriesIntRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MenuiseriesIntRepository.php';

return $this->privates['App\\Repository\\MenuiseriesIntRepository'] = new \App\Repository\MenuiseriesIntRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
