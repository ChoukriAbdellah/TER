...
// Returns the private 'App\Repository\EtudeSolRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EtudeSolRepository.php';

return $this->privates['App\Repository\EtudeSolRepository'] = new \App\Repository\EtudeSolRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
