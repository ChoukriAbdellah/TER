...
class __TwigTemplate_4cae16e4427c39b379f777a68774f8dd547d655a7ce9503ad432f80116bb7988 extends Twig_Template
{
    private $source;
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                // line 101
                if ((twig_get_attribute($this->env, $this->source, (isset($context["data"]) || array_key_exists("data", $context) ? $context["data"] : (function () { throw new Twig_Error_Runtime('Variable "data" does not exist.', 101, $this->source); })()), $context["p"], [], "array") == 23)) {
                    // line 102
                    echo "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
                    echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("facture", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["projets"]) || array_key_exists("projets", $context) ? $context["projets"] : (function () { throw new Twig_Error_Runtime('Variable "projets" does not exist.', 102, $this->source); })()), $context["p"], [], "array"), "id", [])]), "html", null, true);
...
\t\t\t\t\t\t\t\t\t\t\t\t\t";
        // line 129
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new Twig_Error_Runtime('Variable "form" does not exist.', 129, $this->source); })()), 'form_start');
        echo "
\t\t\t\t\t\t\t\t\t\t\t\t\t<br><br>

\t\t\t\t\t\t\t\t\t\t\t\t\t";
        // line 132
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new Twig_Error_Runtime('Variable "form" does not exist.', 132, $this->source); })()), "oldPassword", []), 'label', ["label_attr" => ["class" => "col-sm-3 control-label"], "label" => "Quel est votre ancien mot de passe ? "]);
        echo "
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-9\">
\t\t\t\t\t\t\t\t\t\t\t\t\t";
        // line 134
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new Twig_Error_Runtime('Variable "form" does not exist.', 134, $this->source); })()), "oldPassword", []), 'row', ["attr" => ["class" => "form-control input-lg mb-md"]]);
        echo "
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t";
        // line 136
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new Twig_Error_Runtime('Variable "form" does not exist.', 136, $this->source); })()), "plainPassword", []), "first", []), 'label', ["label_attr" => ["class" => "col-sm-3 control-label", "placeholder" => "Mot de passe"], "label" => "Quel est votre nouveau mot de passe ? "]);
        echo "
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-9\">
\t\t\t\t\t\t\t\t\t\t\t\t\t";
        // line 138
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new Twig_Error_Runtime('Variable "form" does not exist.', 138, $this->source); })()), "plainPassword", []), "first", []), 'row', ["attr" => ["class" => "form-control input-lg mb-md"]]);
        echo "
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t";
        // line 140
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new Twig_Error_Runtime('Variable "form" does not exist.', 140, $this->source); })()), "plainPassword", []), "second", []), 'label', ["label_attr" => ["class" => "col-sm-3 control-label"], "label" => "Répetez le mot de passe ? "]);
        echo "
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-9\">
\t\t\t\t\t\t\t\t\t\t\t\t\t";
        // line 142
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new Twig_Error_Runtime('Variable "form" does not exist.', 142, $this->source); })()), "plainPassword", []), "second", []), 'row', ["attr" => ["class" => "form-control input-lg mb-md"]]);
        echo "
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>

\t\t\t\t\t\t\t\t\t\t\t\t\t";
        // line 145
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new Twig_Error_Runtime('Variable "form" does not exist.', 145, $this->source); })()), "email", []), 'label', ["label_attr" => ["class" => "col-sm-3 control-label"], "label" => "Voulez vous changer l'email ? (faculatif)  "]);
        echo "
\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-9\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
        // line 147
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new Twig_Error_Runtime('Variable "form" does not exist.', 147, $this->source); })()), "email", []), 'row', ["attr" => ["class" => "form-control input-lg mb-md"]]);
        echo "
\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
...
\t\t";
    ...
    {
        return array (  512 => 197,  508 => 196,  504 => 195,  500 => 194,  496 => 193,  492 => 192,  488 => 191,  484 => 190,  480 => 189,  476 => 188,  472 => 187,  468 => 186,  464 => 185,  460 => 184,  456 => 183,  452 => 182,  448 => 181,  444 => 180,  440 => 179,  436 => 178,  432 => 177,  428 => 176,  424 => 175,  420 => 174,  416 => 173,  412 => 171,  403 => 170,  376 => 152,  368 => 147,  363 => 145,  357 => 142,  352 => 140,  347 => 138,  342 => 136,  337 => 134,  332 => 132,  326 => 129,  309 => 114,  306 => 113,  295 => 107,  291 => 105,  284 => 102,  282 => 101,  273 => 95,  267 => 94,  263 => 92,  259 => 90,  255 => 88,  253 => 87,  249 => 86,  245 => 85,  241 => 83,  236 => 82,  234 => 81,  201 => 50,  197 => 48,  191 => 46,  189 => 45,  186 => 44,  180 => 42,  178 => 41,  175 => 40,  169 => 38,  167 => 37,  164 => 36,  158 => 34,  156 => 33,  153 => 32,  147 => 30,  145 => 29,  134 => 20,  125 => 19,  107 => 17,  96 => 14,  87 => 13,  74 => 10,  70 => 9,  66 => 8,  60 => 5,  57 => 4,  48 => 3,  15 => 1,);
    }
