...
// Returns the private 'App\Repository\VrdRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/VrdRepository.php';

return $this->privates['App\Repository\VrdRepository'] = new \App\Repository\VrdRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
