...
// Returns the private 'App\Repository\SecondOeuvreRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SecondOeuvreRepository.php';

return $this->privates['App\Repository\SecondOeuvreRepository'] = new \App\Repository\SecondOeuvreRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
