...
// Returns the private 'App\Repository\ElevationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ElevationRepository.php';

return $this->privates['App\Repository\ElevationRepository'] = new \App\Repository\ElevationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
