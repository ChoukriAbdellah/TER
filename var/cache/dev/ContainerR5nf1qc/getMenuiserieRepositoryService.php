...
// Returns the private 'App\Repository\MenuiserieRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MenuiserieRepository.php';

return $this->privates['App\Repository\MenuiserieRepository'] = new \App\Repository\MenuiserieRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
