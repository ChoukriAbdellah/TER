...
// Returns the private 'App\Repository\ToitureRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ToitureRepository.php';

return $this->privates['App\Repository\ToitureRepository'] = new \App\Repository\ToitureRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
