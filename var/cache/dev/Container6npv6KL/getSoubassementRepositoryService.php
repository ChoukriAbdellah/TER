...
// Returns the private 'App\Repository\SoubassementRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SoubassementRepository.php';

return $this->privates['App\Repository\SoubassementRepository'] = new \App\Repository\SoubassementRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
