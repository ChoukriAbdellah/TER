...
// Returns the private 'App\Repository\CharpenteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CharpenteRepository.php';

return $this->privates['App\Repository\CharpenteRepository'] = new \App\Repository\CharpenteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
