...
// Returns the private 'App\Repository\PrixRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PrixRepository.php';

return $this->privates['App\\Repository\\PrixRepository'] = new \App\Repository\PrixRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
