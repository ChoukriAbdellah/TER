...
// Returns the private 'App\Repository\ElectriciteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ElectriciteRepository.php';

return $this->privates['App\\Repository\\ElectriciteRepository'] = new \App\Repository\ElectriciteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
