...
class __TwigTemplate_434e6971a0db06391befa7a34aad798e033dc41048e0d305fcf8069e1657cb3a extends \Twig\Template
{
    private $source;
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
        // line 35
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "surfaceChambreSalon", []), 'label', ["label_attr" => ["class" => "col-sm-3 control-label"], "label" => "Indiquez la surface totale à ventiler(chambre + cuisine). "]);
        echo "\t\t\t\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-9\">
\t\t\t\t\t\t\t\t\t\t\t\t\t";
        // line 37
