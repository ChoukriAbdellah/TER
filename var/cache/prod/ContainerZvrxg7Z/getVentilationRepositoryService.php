...
// Returns the private 'App\Repository\VentilationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/VentilationRepository.php';

return $this->privates['App\\Repository\\VentilationRepository'] = new \App\Repository\VentilationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
