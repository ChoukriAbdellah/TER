...
// Returns the private 'App\Repository\DomotiqueRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DomotiqueRepository.php';

return $this->privates['App\\Repository\\DomotiqueRepository'] = new \App\Repository\DomotiqueRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
