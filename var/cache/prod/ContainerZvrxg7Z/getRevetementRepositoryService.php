...
// Returns the private 'App\Repository\RevetementRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/RevetementRepository.php';

return $this->privates['App\\Repository\\RevetementRepository'] = new \App\Repository\RevetementRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
