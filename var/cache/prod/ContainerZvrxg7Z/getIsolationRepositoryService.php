...
// Returns the private 'App\Repository\IsolationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/IsolationRepository.php';

return $this->privates['App\\Repository\\IsolationRepository'] = new \App\Repository\IsolationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
