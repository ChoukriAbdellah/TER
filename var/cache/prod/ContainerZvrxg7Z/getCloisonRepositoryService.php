...
// Returns the private 'App\Repository\CloisonRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CloisonRepository.php';

return $this->privates['App\\Repository\\CloisonRepository'] = new \App\Repository\CloisonRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
