...
// Returns the private 'App\Repository\EnduitRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EnduitRepository.php';

return $this->privates['App\\Repository\\EnduitRepository'] = new \App\Repository\EnduitRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
