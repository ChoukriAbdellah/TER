...
// Returns the private 'App\Repository\ClimatisationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ClimatisationRepository.php';

return $this->privates['App\\Repository\\ClimatisationRepository'] = new \App\Repository\ClimatisationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
