...
// Returns the private 'App\Repository\PlancherRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PlancherRepository.php';

return $this->privates['App\\Repository\\PlancherRepository'] = new \App\Repository\PlancherRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
